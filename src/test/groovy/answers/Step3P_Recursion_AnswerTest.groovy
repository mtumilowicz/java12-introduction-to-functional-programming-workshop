...
class Step3P_Recursion_AnswerTest extends Specification {
    ...
    def "test iteratePositivesUpTo < 0"() {
        ...
        expect:
        Step3P_Recursion_Answer.iteratePositivesUpTo(max) == List.empty()
    }
    ...
    def "test iteratePositivesUpTo > 0"() {
        ...
        expect:
        Step3P_Recursion_Answer.iteratePositivesUpTo(max) == List.of(1, 2, 3, 4, 5)
    }
    ...
    def "test filterEven all even"() {
        ...
        expect:
        Step3P_Recursion_Answer.filterEven(evens) == List.of(-2, 2, 4, 6)
    }
    ...
    def "test filterEven all odd"() {
        ...
        expect:
        Step3P_Recursion_Answer.filterEven(evens) == List.empty()
    }
    ...
    def "test sumOfSquaresOfPositiveEvenNumbersUpTo < 0"() {
        ...
        expect:
        Step3P_Recursion_Answer.sumOfSquaresOfPositiveEvenNumbersUpTo(max) == 0
    }
    ...
    def "test sumOfSquaresOfPositiveEvenNumbersUpTo > 0"() {
        ...
        expect:
        Step3P_Recursion_Answer.sumOfSquaresOfPositiveEvenNumbersUpTo(max) == 364
    }
}
